...
function updateUser(request, response) {
    var userIdToUpdate = request.body.userId; // Assuming you pass the userId as a parameter in the URL

    var updatedUserData = {
        'password': request.body.password, // Update the fields you want to change
        'emailId': request.body.emailId
    };
    ...
    UserData.findOneAndUpdate({ 'userID': userIdToUpdate }, updatedUserData, { new: true })
        .then((updatedUser) => {
            if (updatedUser) {
...
app.put('/updateUser', bparseinit, updateUser);
